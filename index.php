<?php
  ...
  $theDrinks = array(
    'counterstrike'=>10.25,
    'leagueoflegends'=>12.5,
    'halo'=>14.25,
    'gearsofwar'=>14.25,
    'callofduty'=>41.25,
    'streetfighter'=>61.25,
    'supersmashbros'=>34.25,
    'overwatch'=>54.25,
    'dota2'=>104.75
  );
...
<html lang="en">
  ...
  <body class="bg-faded">
    <main class="container py-4">
      <h1 class="pb-4 font-weight-bold text-center">Game-Mart</h1>
      <form class="form-inline justify-content-center" action="" method="post">
        <label for="name" class="sr-only">Name</label>
        <input class="form-control mr-2" type="text" value="<?php echo ( $theName ? $theName : '' );?>" placeholder="Name" name="name" id="name"> <span class="mr-2">wants to buy</span>
        <select class="custom-select mr-2" name="coffee" id="coffee">
          <?php echo '<option value="'.( $theCoffee ? $theCoffee : 'nothing' ).'">'.( $theCoffee ? capfirst($theCoffee) : 'Select a game' ).'</option>'; ?>
